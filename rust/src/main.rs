...
const AOC: Aoc = Aoc {
    ...
    solutions: &[
        ...
        solution! { 20, parser!{ day20::input_generator }, solver!{ day20::part1 }},
        solution! { 20, parser!{ day20::input_generator }, solver!{ day20::part2 }},
        solution! { 21, parser!{ day21::input_generator }, solver!{ day21::part1 }},
        solution! { 21, parser!{ day21::input_generator }, solver!{ day21::part2 }},
        solution! { 22, parser!{ day22::input_generator }, solver!{ day22::part1 }},
        solution! { 22, parser!{ day22::input_generator }, solver!{ day22::part2 }},
        solution! { 23, parser!{ day23::input_generator }, solver!{ day23::part1 }},
        solution! { 23, parser!{ day23::input_generator }, solver!{ day23::part2 }},
        solution! { 24, parser!{ day24::input_generator }, solver!{ day24::part1 }},
        solution! { 24, parser!{ day24::input_generator }, solver!{ day24::part2 }},
        solution! { 25, parser!{ day25::input_generator }, solver!{ day25::part1 }},
    ],
};
